...
const { createPBAds, validateCampaign, wordCount } = require('../src/services/pb-ads');
...
const base = {
  ...
  imageAlt:'Imagen de prueba', destinationUrl:'https://example.com/oferta', status:'active',
  startsAt:'', endsAt:'', sections:['blog'], categories:[], placements:['blog.inline_1'],
  priority:10, advertiser:'Prueba', affiliateNetwork:'', excludedArtisanCategories:[],
  createdAt:now, updatedAt:now
};
const campaigns = [
  {...base,id:'pbad-internal',internalName:'Interna',type:'internal',destinationUrl:'/agenda-boricua'},
  ...
  {...base,id:'pbad-artisan',internalName:'Artesanos',type:'affiliate',sections:['artisan'],placements:['artisan.after_profile'],excludedArtisanCategories:['joyeria']}
];
