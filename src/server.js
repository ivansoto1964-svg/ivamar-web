...
app.get("/sitemap.xml", async (req, res) => {
  ...
  if (host.includes('yourcaribbeanexpert')) {
    const base = "https://www.yourcaribbeanexpert.com";
    const destinations = ['puerto-rico','dominican-republic','cuba','jamaica','grand-cayman','haiti','vieques-culebra','barbados','santa-lucia','trinidad-tobago','sint-maarten','martinique','guadeloupe','st-barths','grenada','antigua','dominica','st-kitts-nevis','aruba','curacao','bonaire','usvi','bvi','turks-caicos','bahamas','tulum','cartagena','san-andres','costa-rica','belize','panama','roatan','venezuela','corn-islands','guatemala-caribbean'];
    const urls = [`<url><loc>${base}/</loc><changefreq>weekly</changefreq><priority>1.0</priority></url>`,`<url><loc>${base}/caribex</loc><changefreq>weekly</changefreq><priority>0.9</priority></url>`,`<url><loc>${base}/about</loc><changefreq>monthly</changefreq><priority>0.7</priority></url>`,`<url><loc>${base}/privacidad</loc><changefreq>monthly</changefreq><priority>0.5</priority></url>`,`<url><loc>${base}/terminos</loc><changefreq>monthly</changefreq><priority>0.5</priority></url>`,...destinations.map(s=>`<url><loc>${base}/caribex/${s}</loc><changefreq>monthly</changefreq><priority>0.8</priority></url>`)].join('');
