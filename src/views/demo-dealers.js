    ...
    <div>
      ...
      <div style="background:#fff;border:1px solid var(--border);border-radius:12px;padding:1.2rem;margin-bottom:1rem;">
        ...
        <div style="display:flex;flex-direction:column;gap:0.5rem;">
          <div style="font-size:0.78rem;color:var(--dark);">🚗 "What SUVs do you have in stock?"</div>
          ...
          <div style="font-size:0.78rem;color:var(--dark);">🔧 "I need a service appointment"</div>
          <div style="font-size:0.78rem;color:var(--dark);">📅 "Can I schedule a test drive?"</div>
          <div style="font-size:0.78rem;color:var(--dark);">🇪🇸 "¿Qué vehículos tienen disponibles?"</div>
        </div>
      </div>
      ...
      <div class="ac-header">
        <div class="ac-info">
          ...
          <div>
            ...
            <div class="ac-status">● Online · Your Dealership</div>
          </div>
        </div>
  ...
  <div class="plans-inner">
    ...
    <div class="plans-grid">
      <div class="plan">
        ...
        <a href="mailto:connect@ivamarai.com?subject=Dealer Demo - Starter Plan Interest" class="plan-btn">Get Started →</a>
      </div>
      <div class="plan featured">
        ...
        <a href="mailto:connect@ivamarai.com?subject=Dealer Demo - Multi Plan Interest" class="plan-btn">Get Started →</a>
      </div>
      <div class="plan">
        ...
        <a href="mailto:connect@ivamarai.com?subject=Dealer Group - Full Group Plan Interest" class="plan-btn">Get Started →</a>
      </div>
    </div>
  </div>
</section>
...
<section class="cta">
  <div class="cta-inner">
    ...
    <a href="mailto:connect@ivamarai.com?subject=Dealer Demo - Assistant Interest" class="btn-white">📧 Email Us to Get Started</a>
...
<footer>
  ...
  <div class="footer-info">
    ...
    AI Assistants for Car Dealerships · USA & LATAM
  </div>
