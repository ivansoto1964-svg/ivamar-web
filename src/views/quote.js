...
<div class="iva-quote">
  ...
  <div class="iva-q-content">
    ...
    <div class="iva-q-card">
      ...
      <p style="font-size:0.78rem;color:#8892A4;margin:1rem 0 0.8rem;">🌐 <strong style="color:#1a1a2e">Assistant + Landing Page</strong> — we build your page too</p>
      <div class="iva-q-plans">
      ...
      <p style="font-size:0.72rem;color:#4A5568;margin-top:1rem;text-align:center;">Need something custom? <a href="https://wa.me/18635216708" target="_blank" style="color:#00C896">Contact us on WhatsApp →</a></p>
    </div>
