...
.iva-badge-dot {
  ...
  background: #00E5C8;
  border-radius: 50%;
  animation: ivaBlink 2s ease-in-out infinite;
}
...
.iva-pricing-card::before {
  content: '';
  position: absolute; top: 0; left: 0; right: 0;
  height: 2px;
  background: linear-gradient(90deg, transparent, #00E5C8, #E8C97A, #00E5C8, transparent);
}
.iva-pricing-badge {
  display: inline-flex;
  align-items: center;
...
<div class="iva-page">
  ...
  <div class="iva-hero">
    ...
    <div class="iva-badge">
      <span class="iva-badge-dot"></span>
      NOW SERVING PR & USA · AHORA EN PR Y USA
    </div>

    <h1>The <em>Human Touch</em><br>of Intelligence</h1>

    <p class="iva-hero-sub">
      AI-powered pages for real businesses. Your customers ask questions, order, and pay — all without you lifting a finger.
    </p>
    ...
    <div class="iva-stats">
      <div class="iva-stat">
        <div class="iva-stat-num">$125<span></span></div>
        <div class="iva-stat-label">One-time setup</div>
      </div>
      <div class="iva-stat">
        <div class="iva-stat-num">$49<span>/mo</span></div>
        <div class="iva-stat-label">Monthly hosting</div>
      </div>
      <div class="iva-stat">
        <div class="iva-stat-num">0<span>%</span></div>
        <div class="iva-stat-label">Commission</div>
      </div>
      <div class="iva-stat">
        <div class="iva-stat-num">24<span>/7</span></div>
        <div class="iva-stat-label">IvA Assistant</div>
      </div>
    </div>
  </div>
  ...
  <div class="iva-section iva-section-dark" id="how">
    <div class="iva-inner">
      <div class="iva-section-label">Process</div>
      <h2 class="iva-section-title">Up and running<br>in <em>48 hours</em></h2>
      <div class="iva-steps">
        <div class="iva-step">
          <div class="iva-step-num">01 / SETUP</div>
          <span class="iva-step-icon">📋</span>
          <div class="iva-step-title">Share your info</div>
          <div class="iva-step-desc">Send us your logo, menu or services, prices and business details. We handle everything else.</div>
        </div>
        <div class="iva-step">
          <div class="iva-step-num">02 / LAUNCH</div>
          <span class="iva-step-icon">🚀</span>
          <div class="iva-step-title">Go live</div>
          <div class="iva-step-desc">Your page is published on your custom link. IvA is trained on your business and ready to answer questions.</div>
        </div>
        <div class="iva-step">
          <div class="iva-step-num">03 / SELL</div>
          <span class="iva-step-icon">💰</span>
          <div class="iva-step-title">Customers order & pay</div>
          <div class="iva-step-desc">IvA guides customers to WhatsApp or checkout. Orders and payments go directly to you. Zero commissions.</div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="iva-inner">
      ...
      <div class="iva-features">
        <div class="iva-feature">
          ...
          <div class="iva-feature-title">IvA — Your AI Assistant</div>
          <div class="iva-feature-desc">Trained on your business. Answers questions, takes orders, and guides customers 24/7 in English and Spanish.</div>
          <span class="iva-feature-tag">BILINGUAL · EN + ES</span>
        </div>
        <div class="iva-feature">
          <div class="iva-feature-icon">📱</div>
          <div class="iva-feature-title">Mobile-First Landing Page</div>
          <div class="iva-feature-desc">A beautiful, fast page designed for phones. Your menu, services, photos and prices — all in one place.</div>
          <span class="iva-feature-tag">OPTIMIZED FOR MOBILE</span>
        </div>
        <div class="iva-feature">
          <div class="iva-feature-icon">💳</div>
          <div class="iva-feature-title">Direct Payments</div>
          <div class="iva-feature-desc">Customers pay directly to your account via Stripe, ATH Móvil, PayPal or Square. No cuts, no waiting.</div>
          <span class="iva-feature-tag">0% COMMISSION</span>
        </div>
        <div class="iva-feature">
          <div class="iva-feature-icon">📲</div>
          <div class="iva-feature-title">WhatsApp Order Flow</div>
          <div class="iva-feature-desc">Orders formatted and sent directly to your WhatsApp with all details. No app to download, no training needed.</div>
          <span class="iva-feature-tag">INSTANT NOTIFICATIONS</span>
        </div>
        <div class="iva-feature wide">
          <div class="iva-feature-icon">🏪</div>
          <div class="iva-feature-title">Perfect for Any Local Business in PR & USA</div>
          <div class="iva-feature-desc">Food trucks, bakeries, chinchorros, salons, car dealers, contractors — if you have customers, IvA works for you.</div>
          <span class="iva-feature-tag">FOOD TRUCKS · RESTAURANTS · SERVICES · RETAIL · AUTO</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="iva-section iva-section-dark" id="pricing">
    <div class="iva-inner" style="text-align:center">
      <div class="iva-section-label" style="justify-content:center">Pricing / Precio</div>
      <h2 class="iva-section-title">Simple. <em>Transparent.</em> Yours.</h2>
      <div class="iva-pricing-card">
        <div class="iva-pricing-badge">⭐ First month free · Primer mes gratis</div>
        <div class="iva-price">
          <span class="iva-price-currency">$</span>
          <span class="iva-price-amount">49</span>
          <span class="iva-price-period">/month</span>
        </div>
  ...
  <div class="iva-cta">
    ...
    <div class="iva-cta-btns">
      ...
      <a href="https://forms.gle/cW7qTdj5zTx2S4ZH7" target="_blank" class="iva-btn-ghost">Request demo</a>
    </div>
  </div>

  <!-- FOOTER -->
  <div class="iva-footer">
    <div>© 2025 <strong>Ivamar AI</strong> · Puerto Rico & USA · All rights reserved</div>
    <div class="iva-footer-links">
      <a href="/privacy">Privacy</a>
      <a href="/terms">Terms</a>
      <a href="/about">About</a>
      <a href="https://wa.me/18635216708" target="_blank">Contact</a>
    </div>
  </div>
