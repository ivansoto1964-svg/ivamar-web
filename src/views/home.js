...
.iva-page {
  --void:#030508;--deep:#080C12;--surface:#0D1420;--panel:#111827;
  --cyan:#00E5C8;--ivawhite:#F0F4FF;--soft:#8892A4;--gold:#E8C97A;
  font-family:'Syne',sans-serif;background:var(--void);color:var(--ivawhite);
  margin:-20px;overflow-x:hidden;
}
...
.iva-orb-3{width:250px;height:250px;background:rgba(255,77,109,0.04);top:20%;right:5%;animation:ivaDrift2 12s ease-in-out infinite reverse;}
...
.iva-hero-sub{max-width:560px;color:#8892A4;font-size:1.05rem;line-height:1.7;margin-bottom:2.5rem;font-weight:400;position:relative;}
...
.iva-pricing-badge{display:inline-flex;align-items:center;gap:0.4rem;background:rgba(232,201,122,0.1);border:1px solid rgba(232,201,122,0.3);color:#E8C97A;font-size:0.75rem;font-family:'JetBrains Mono',monospace;padding:0.3rem 0.8rem;border-radius:100px;margin-bottom:1.5rem;letter-spacing:0.08em;}
...
<div class="iva-page">
  ...
  <div class="iva-hero">
    ...
    <div class="iva-orb iva-orb-3"></div>
    ...
    <p class="iva-hero-sub">
      Creamos páginas con asistente de IA para negocios reales. Tus clientes preguntan, ordenan y pagan — sin que tú tengas que estar al teléfono.<br><br>
      <span style="font-size:0.9rem;opacity:0.7">AI-powered pages for real businesses in PR & USA.</span>
    </p>
    <div class="iva-hero-actions">
      <a href="https://forms.gle/cW7qTdj5zTx2S4ZH7" target="_blank" class="iva-btn-main">Solicitar Demo →</a>
  ...
  <div class="iva-section iva-section-dark" id="how">
    <div class="iva-inner">
      ...
      <div class="iva-steps">
        <div class="iva-step">
          <div class="iva-step-num">01 / SETUP</div>
          <span class="iva-step-icon">📋</span>
          <div class="iva-step-title">Nos envías tu info</div>
          <div class="iva-step-desc">Tu logo, menú o servicios, precios y datos del negocio. Nosotros configuramos todo por ti.</div>
        </div>
        <div class="iva-step">
          <div class="iva-step-num">02 / LAUNCH</div>
          <span class="iva-step-icon">🚀</span>
          <div class="iva-step-title">Tu página sale en vivo</div>
          <div class="iva-step-desc">Publicamos en tu link personalizado. IvA ya conoce tu negocio y está listo para atender clientes 24/7.</div>
        </div>
        <div class="iva-step">
          <div class="iva-step-num">03 / SELL</div>
          <span class="iva-step-icon">💰</span>
          <div class="iva-step-title">Clientes ordenan y pagan</div>
          <div class="iva-step-desc">IvA guía a tus clientes a WhatsApp o al checkout. Los pagos van directo a tu cuenta. Cero comisiones.</div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="iva-section iva-section-void" id="features">
    <div class="iva-inner">
      ...
      <div class="iva-features">
        <div class="iva-feature">
          <div class="iva-feature-icon">🤖</div>
          <div class="iva-feature-title">IvA — Tu Asistente de IA</div>
          <div class="iva-feature-desc">Entrenado con la info de tu negocio. Responde preguntas, toma órdenes y guía clientes las 24 horas en inglés y español.</div>
          <span class="iva-feature-tag">BILINGÜE · EN + ES</span>
        </div>
        <div class="iva-feature">
          <div class="iva-feature-icon">📱</div>
          <div class="iva-feature-title">Landing Page Mobile-First</div>
          <div class="iva-feature-desc">Una página hermosa y rápida diseñada para teléfonos. Tu menú, servicios, fotos y precios en un solo lugar.</div>
          <span class="iva-feature-tag">OPTIMIZADA PARA MÓVIL</span>
        </div>
        <div class="iva-feature">
          <div class="iva-feature-icon">💳</div>
          <div class="iva-feature-title">Pagos Directos al Comerciante</div>
          <div class="iva-feature-desc">Acepta Stripe, ATH Móvil, PayPal o Square. El dinero va directo a tu cuenta — sin intermediarios ni esperas.</div>
          <span class="iva-feature-tag">0% COMISIÓN</span>
        </div>
        <div class="iva-feature">
          <div class="iva-feature-icon">📲</div>
          <div class="iva-feature-title">Pedidos por WhatsApp</div>
          <div class="iva-feature-desc">Los pedidos llegan formateados directo a tu WhatsApp con todos los detalles. Sin apps, sin complicaciones.</div>
          <span class="iva-feature-tag">NOTIFICACIONES INSTANTÁNEAS</span>
        </div>
        <div class="iva-feature wide">
          <div class="iva-feature-icon">🏪</div>
          <div class="iva-feature-title">Ideal para Cualquier Negocio Local en PR y USA</div>
          <div class="iva-feature-desc">Food trucks, panaderías, chinchorros, salones, dealers de autos, contratistas, servicios profesionales — si tienes clientes, IvA trabaja para ti.</div>
          <span class="iva-feature-tag">FOOD TRUCKS · RESTAURANTES · SERVICIOS · RETAIL · AUTOS</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="iva-section iva-section-dark" id="pricing">
    <div class="iva-inner" style="text-align:center">
      <div class="iva-section-label" style="justify-content:center">Precios / Pricing</div>
      <h2 class="iva-section-title">Simple. <em>Transparente.</em> Tuyo.</h2>
      <div class="iva-pricing-card">
        <div class="iva-pricing-badge">⭐ Primer mes gratis · First month free</div>
        <div class="iva-price">
          <span class="iva-price-currency">$</span>
          <span class="iva-price-amount">49</span>
          <span class="iva-price-period">/mes</span>
        </div>
        ...
        <ul class="iva-pricing-list">
          ...
          <li>Asistente IvA 24/7</li>
          <li>Pedidos por WhatsApp</li>
          <li>Integración de pagos</li>
          <li>Bilingüe EN + ES</li>
          <li>Hosting y actualizaciones</li>
          <li>Editor de menú</li>
  ...
  <div class="iva-cta">
    ...
    <p>Únete a negocios en Puerto Rico y USA que ya usan Ivamar AI para vender más y trabajar menos. Your business, powered by AI.</p>
    <div class="iva-cta-btns">
      <a href="https://wa.me/18635216708" target="_blank" class="iva-btn-main">Hablar por WhatsApp →</a>
      <a href="https://forms.gle/cW7qTdj5zTx2S4ZH7" target="_blank" class="iva-btn-ghost">Solicitar demo</a>
    </div>
  </div>
