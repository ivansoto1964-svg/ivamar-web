...
/* Food Truck theme */
.demo-card.ft .demo-card-hero{background:linear-gradient(135deg,#1a0a00,#0F0A00);}
.demo-card.ft .demo-card-tag{background:rgba(255,77,0,0.15);color:#FF4D00;border:1px solid rgba(255,77,0,0.3);}
.demo-card.ft .demo-card-btn{background:rgba(255,77,0,0.1);color:#FF4D00;border:1px solid rgba(255,77,0,0.2);}
.demo-card.ft:hover{border-color:rgba(255,77,0,0.3);}
...
<div class="demos-page">
  ...
  <nav class="demos-nav">
    <a href="/" class="demos-logo">
      <div class="demos-logo-mark">IvA</div>
  ...
  <div class="demos-grid">
    ...
    <!-- FOOD TRUCK -->
    <a href="/demo" class="demo-card ft">
      <div class="demo-card-hero">
        <div class="demo-card-tag">🔥 En vivo</div>
        <div class="demo-card-emoji">🚚</div>
      </div>
      <div class="demo-card-body">
        <div class="demo-card-industry">Food Truck · Restaurante · Cafetería</div>
        <div class="demo-card-title">El Rincón Boricua</div>
        <div class="demo-card-desc">Menú digital con fotos, carrito de pedidos, opciones de delivery y pickup, instrucciones especiales, y El Bori — el asistente boricua 24/7.</div>
        <div class="demo-card-features">
          ...
          <span class="demo-card-feature">El Bori IA</span>
        </div>
        <div class="demo-card-btn">Ver demo del food truck →</div>
      </div>
    </a>
    ...
    <a href="/demo-autos" class="demo-card auto">
      ...
      <div class="demo-card-body">
        ...
        <div class="demo-card-desc">Inventario de vehículos, filtros por tipo, testimonios de clientes, y IvA — el asistente que captura leads y responde sobre financiamiento 24/7.</div>
        <div class="demo-card-features">
    ...
    <div class="demo-card soon">
      ...
      <div class="demo-card-body">
        ...
        <div class="demo-card-desc">Servicios, precios, galería de fotos y reservaciones directas por WhatsApp con IvA como asistente.</div>
        <div class="demo-card-features">
    ...
    <div class="demo-card soon">
      ...
      <div class="demo-card-body">
        ...
        <div class="demo-card-desc">Listado de propiedades, captura de leads calificados y asistente IA que pre-califica compradores 24/7.</div>
        <div class="demo-card-features">
  ...
  <div class="demos-cta">
    ...
    <p>En 48 horas tu negocio tiene su propia página con asistente IA. Setup $125 + $49/mes. Primer mes gratis.</p>
