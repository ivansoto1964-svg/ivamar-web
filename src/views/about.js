...
.about-logo-mark{width:32px;height:32px;border:1.5px solid #00E5C8;border-radius:8px;display:flex;align-items:center;justify-content:center;font-family:'JetBrains Mono',monospace;font-size:0.7rem;color:#00E5C8;background:rgba(0,229,200,0.06);}
.about-logo-text{font-size:1.1rem;font-weight:700;color:#F0F4FF;letter-spacing:-0.02em;}
.about-logo-text span{color:#00E5C8;}
...
.about-legal-title{font-size:0.8rem;font-weight:700;margin-bottom:0.8rem;color:#F0F4FF;}
