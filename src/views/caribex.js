    ...
    .then(data => {
      ...
      if (entries[0]) {
        ...
        document.getElementById('hero-featured-post').innerHTML =
          ...
          '<img class="hero-post-img" src="' + getImg(e) + '" alt="' + e.title.$t + '" onerror="this.parentNode.style.display=`none`">' +
      ...
      if (grid) {
        ...
        grid.innerHTML = posts.map(e =>
          ...
          '<img src="' + getImg(e) + '" alt="" style="width:100%;height:100%;object-fit:cover;" onerror="this.style.visibility='hidden'">' +
          '</div>' +
