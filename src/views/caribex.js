...
.island-card-img{height:160px;overflow:hidden;position:relative;}
.island-card-img img{width:100%;height:100%;object-fit:cover;transition:transform 0.3s;}
.island-card:hover .island-card-img img{transform:scale(1.05);}
.island-card-img .flag{position:absolute;bottom:8px;left:8px;font-size:1.5rem;background:rgba(0,0,0,0.4);border-radius:6px;padding:2px 6px;}
...
<section class="destinations" id="destinations">
  <div class="dest-inner">
    ...
    <p class="sec-sub">35 destinations organized by region — from the Greater Antilles to the Caribbean mainland. Every corner of the Caribbean in one place.</p>
    <!-- GREATER ANTILLES -->
    <div class="region-section">
      <div class="region-label">🏝️ Greater Antilles</div>
      <div class="islands-grid">
        <a href="/caribex/puerto-rico" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#006994,#00A8CC);"><img src="https://loremflickr.com/400/300/puerto,rico,caribbean" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇵🇷</span></div><div class="island-card-body"><div class="island-card-region">Greater Antilles</div><div class="island-card-name">Puerto Rico</div><div class="island-card-desc">Old San Juan, El Yunque rainforest, bioluminescent bays and the soul of the Caribbean.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/dominican-republic" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#1B4332,#40916C);"><img src="https://loremflickr.com/400/300/dominican,republic,beach" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇩🇴</span></div><div class="island-card-body"><div class="island-card-region">Greater Antilles</div><div class="island-card-name">Dominican Republic</div><div class="island-card-desc">Punta Cana, Santo Domingo's colonial zone and merengue nights.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-culture">Culture</span></div></a>
        <a href="/caribex/cuba" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#003049,#C1121F);"><img src="https://images.unsplash.com/photo-1501854140801-50d01698950b?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇨🇺</span></div><div class="island-card-body"><div class="island-card-region">Greater Antilles</div><div class="island-card-name">Cuba</div><div class="island-card-desc">Havana's vintage cars, Viñales tobacco fields and salsa rhythms.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-nature">Nature</span></div></a>
        <a href="/caribex/jamaica" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#5C4033,#8D6E63);"><img src="https://images.unsplash.com/photo-1568265112889-b4de1be94cec?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇯🇲</span></div><div class="island-card-body"><div class="island-card-region">Greater Antilles</div><div class="island-card-name">Jamaica</div><div class="island-card-desc">Reggae birthplace, Blue Mountains coffee and Dunn's River Falls.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/grand-cayman" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#012169,#00B4D8);"><img src="https://images.unsplash.com/photo-1590523741831-ab7e8b8f9c7f?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇰🇾</span></div><div class="island-card-body"><div class="island-card-region">Greater Antilles</div><div class="island-card-name">Grand Cayman</div><div class="island-card-desc">Seven Mile Beach, Stingray City and world-class wall diving.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-luxury">Luxury</span></div></a>
        <a href="/caribex/haiti" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#00209F,#D21034);"><img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇭🇹</span></div><div class="island-card-body"><div class="island-card-region">Greater Antilles</div><div class="island-card-name">Haiti</div><div class="island-card-desc">The first free Black republic — Citadelle Laferrière, extraordinary art and a history unlike any other.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-nature">Nature</span></div></a>
        <a href="/caribex/vieques-culebra" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#006994,#52B788);"><img src="https://images.unsplash.com/photo-1548574505-5e239809ee19?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇵🇷</span></div><div class="island-card-body"><div class="island-card-region">Puerto Rico Offshore</div><div class="island-card-name">Vieques & Culebra</div><div class="island-card-desc">The world's brightest bioluminescent bay and Flamenco Beach — Puerto Rico's hidden island treasures.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-nature">Nature</span></div></a>
      </div>
    </div>
    ...
    <div class="region-section">
      ...
      <div class="islands-grid">
        <a href="/caribex/barbados" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#F4A261,#E76F51);"><img src="https://images.unsplash.com/photo-1548678471-51f9e3fba61e?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇧🇧</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Barbados</div><div class="island-card-desc">Rum distilleries, coral reefs and the sophisticated side of the Caribbean.</div><span class="island-tag tag-luxury">Luxury</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/santa-lucia" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#65B741,#1A5276);"><img src="https://images.unsplash.com/photo-1596422846543-6e7b94a6a5bf?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇱🇨</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Saint Lucia</div><div class="island-card-desc">Twin Piton peaks, volcanic springs and the most dramatic scenery in the Eastern Caribbean.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-luxury">Luxury</span></div></a>
        <a href="/caribex/trinidad-tobago" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#C8102E,#000000);"><img src="https://images.unsplash.com/photo-1527090526205-beaac8dc3c84?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇹🇹</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Trinidad & Tobago</div><div class="island-card-desc">Carnival capital, steelpan birthplace and two completely different island personalities.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-nature">Nature</span></div></a>
        <a href="/caribex/sint-maarten" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#003087,#EF4135);"><img src="https://images.unsplash.com/photo-1590523278191-995cbcda2773?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇸🇽</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Sint Maarten / Saint Martin</div><div class="island-card-desc">Two nations, one island — plane spotting at Maho Beach and French cuisine.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-culture">Culture</span></div></a>
        <a href="/caribex/martinique" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#002395,#ED2939);"><img src="https://images.unsplash.com/photo-1544198365-f5d60b6d8190?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇲🇶</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles · France</div><div class="island-card-name">Martinique</div><div class="island-card-desc">French Caribbean — rhum agricole, volcanic Mount Pelée and the finest beaches in the French Antilles.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/guadeloupe" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#009A44,#002395);"><img src="https://images.unsplash.com/photo-1559827291-72a72ab5d9a0?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇬🇵</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles · France</div><div class="island-card-name">Guadeloupe</div><div class="island-card-desc">The butterfly island — volcanic Basse-Terre, beautiful beaches and the finest French Caribbean rum.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-culture">Culture</span></div></a>
        <a href="/caribex/st-barths" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#002395,#F4A261);"><img src="https://loremflickr.com/400/300/st,barts,luxury" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇧🇱</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles · France</div><div class="island-card-name">St. Barths</div><div class="island-card-desc">The Caribbean's most exclusive island — superyacht harbor, world-class restaurants and perfect beaches.</div><span class="island-tag tag-luxury">Luxury</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/grenada" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#CE1126,#009E60);"><img src="https://images.unsplash.com/photo-1567606109953-ef56fd6bbf6b?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇬🇩</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Grenada</div><div class="island-card-desc">The Spice Island — nutmeg plantations, the Bianca C wreck and St. George's most beautiful harbor town.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-culture">Culture</span></div></a>
        <a href="/caribex/antigua" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#CE1126,#0072C6);"><img src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇦🇬</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Antigua & Barbuda</div><div class="island-card-desc">365 beaches, Nelson's Dockyard UNESCO and the Caribbean's most prestigious sailing regatta.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-luxury">Luxury</span></div></a>
        <a href="/caribex/dominica" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#006B3F,#141414);"><img src="https://images.unsplash.com/photo-1502082553048-f009c37129b9?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇩🇲</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Dominica</div><div class="island-card-desc">The Nature Island — boiling lakes, sperm whales, Champagne Reef and the most pristine rainforest in the Eastern Caribbean.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/st-kitts-nevis" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#009E49,#CE1126);"><img src="https://images.unsplash.com/photo-1548574505-5e239809ee19?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇰🇳</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">St. Kitts & Nevis</div><div class="island-card-desc">Britain's first Caribbean colony — Brimstone Hill UNESCO fortress, plantation hotels and birthplace of Alexander Hamilton.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-nature">Nature</span></div></a>
      </div>
    </div>
    ...
    <div class="region-section">
      ...
      <div class="islands-grid">
        <a href="/caribex/aruba" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#0096C7,#48CAE4);"><img src="https://images.unsplash.com/photo-1591604129939-f1efa4d9f7fa?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇦🇼</span></div><div class="island-card-body"><div class="island-card-region">Dutch Caribbean</div><div class="island-card-name">Aruba</div><div class="island-card-desc">360 days of sunshine, Eagle Beach and the most consistent weather in the Caribbean.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-luxury">Luxury</span></div></a>
        <a href="/caribex/curacao" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#003087,#FF6B35);"><img src="https://images.unsplash.com/photo-1568781836524-e5f3a5af5b88?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇨🇼</span></div><div class="island-card-body"><div class="island-card-region">Dutch Caribbean</div><div class="island-card-name">Curaçao</div><div class="island-card-desc">UNESCO colonial Willemstad, world-class wall diving and the most colorful island in the Caribbean.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/bonaire" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#003087,#FF6B35);"><img src="https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇧🇶</span></div><div class="island-card-body"><div class="island-card-region">Dutch Caribbean</div><div class="island-card-name">Bonaire</div><div class="island-card-desc">The diver's paradise — 60+ shore dive sites, flamingos in the salt pans and the Caribbean's most protected reef.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-beach">Beach</span></div></a>
      </div>
    </div>
    ...
    <div class="region-section">
      ...
      <div class="islands-grid">
        <a href="/caribex/usvi" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#002868,#BF0A30);"><img src="https://images.unsplash.com/photo-1559494007-6f0d31f0af3e?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇻🇮</span></div><div class="island-card-body"><div class="island-card-region">US Territory</div><div class="island-card-name">US Virgin Islands</div><div class="island-card-desc">No passport needed — Magens Bay and Virgin Islands National Park.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-nature">Nature</span></div></a>
        <a href="/caribex/bvi" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#012169,#00B4D8);"><img src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇻🇬</span></div><div class="island-card-body"><div class="island-card-region">UK Territory</div><div class="island-card-name">British Virgin Islands</div><div class="island-card-desc">Sailing capital of the Caribbean — The Baths and the legendary Soggy Dollar Bar.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-luxury">Luxury</span></div></a>
        <a href="/caribex/turks-caicos" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#00B4D8,#0077B6);"><img src="https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇹🇨</span></div><div class="island-card-body"><div class="island-card-region">UK Territory</div><div class="island-card-name">Turks & Caicos</div><div class="island-card-desc">Grace Bay — the world's best beach — and the clearest water in the Caribbean.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-luxury">Luxury</span></div></a>
        <a href="/caribex/bahamas" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#023E8A,#0096C7);"><img src="https://images.unsplash.com/photo-1548678471-51f9e3fba61e?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇧🇸</span></div><div class="island-card-body"><div class="island-card-region">Commonwealth</div><div class="island-card-name">The Bahamas</div><div class="island-card-desc">700 islands, swimming pigs in the Exumas and the clearest water on earth.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-luxury">Luxury</span></div></a>
      </div>
    </div>
    ...
    <div class="region-section">
      ...
      <div class="islands-grid">
        <a href="/caribex/tulum" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#2D6A4F,#52B788);"><img src="https://images.unsplash.com/photo-1552074284-6694cebdc97d?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇲🇽</span></div><div class="island-card-body"><div class="island-card-region">Mexico</div><div class="island-card-name">Tulum · Cancún · Holbox</div><div class="island-card-desc">Mayan ruins above Caribbean water, cenotes and bohemian beach culture.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-nature">Nature</span></div></a>
        <a href="/caribex/cartagena" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#FFD700,#C8102E);"><img src="https://images.unsplash.com/photo-1568781836524-e5f3a5af5b88?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇨🇴</span></div><div class="island-card-body"><div class="island-card-region">Colombia</div><div class="island-card-name">Cartagena · Santa Marta</div><div class="island-card-desc">Colombia's walled colonial city — one of the most beautiful in the Americas.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/san-andres" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#FFD700,#003893);"><img src="https://loremflickr.com/400/300/san,andres,colombia,beach" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇨🇴</span></div><div class="island-card-body"><div class="island-card-region">Colombia</div><div class="island-card-name">San Andrés · Providencia</div><div class="island-card-desc">Colombia's Caribbean jewel — the Sea of Seven Colors and pristine coral reef.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-nature">Nature</span></div></a>
        <a href="/caribex/costa-rica" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#1B4332,#52B788);"><img src="https://images.unsplash.com/photo-1502082553048-f009c37129b9?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇨🇷</span></div><div class="island-card-body"><div class="island-card-region">Costa Rica</div><div class="island-card-name">Puerto Viejo · Tortuguero</div><div class="island-card-desc">Where the jungle meets the sea — sea turtles and Afro-Caribbean culture.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-culture">Culture</span></div></a>
        <a href="/caribex/belize" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#003F5C,#00B4D8);"><img src="https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇧🇿</span></div><div class="island-card-body"><div class="island-card-region">Belize</div><div class="island-card-name">Ambergris Caye · Blue Hole</div><div class="island-card-desc">The Great Blue Hole and the second largest barrier reef on earth.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/panama" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#003F88,#00B4D8);"><img src="https://loremflickr.com/400/300/bocas,del,toro,panama" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇵🇦</span></div><div class="island-card-body"><div class="island-card-region">Panama</div><div class="island-card-name">Bocas del Toro · San Blas</div><div class="island-card-desc">Pristine Guna Yala islands and Bocas del Toro water bungalows.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-culture">Culture</span></div></a>
        <a href="/caribex/roatan" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#0F4C81,#00B4D8);"><img src="https://images.unsplash.com/photo-1583212292454-1fe6229603b7?w=400&h=300&fit=crop" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇭🇳</span></div><div class="island-card-body"><div class="island-card-region">Honduras</div><div class="island-card-name">Roatán · Bay Islands</div><div class="island-card-desc">World-class diving at the Caribbean's best value prices.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/venezuela" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#CF0A2C,#003893);"><img src="https://loremflickr.com/400/300/los,roques,venezuela" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇻🇪</span></div><div class="island-card-body"><div class="island-card-region">Venezuela</div><div class="island-card-name">Los Roques · Margarita</div><div class="island-card-desc">The Caribbean's last unspoiled secret — pristine natural archipelagos.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/corn-islands" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#003F7F,#D21034);"><img src="https://loremflickr.com/400/300/corn,islands,nicaragua" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇳🇮</span></div><div class="island-card-body"><div class="island-card-region">Nicaragua</div><div class="island-card-name">Corn Islands</div><div class="island-card-desc">Nicaragua's undiscovered Caribbean paradise — world-class diving and fresh lobster at unbeatable prices.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/guatemala-caribbean" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#4997D0,#009A44);"><img src="https://loremflickr.com/400/300/rio,dulce,guatemala" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇬🇹</span></div><div class="island-card-body"><div class="island-card-region">Guatemala</div><div class="island-card-name">Livingston · Rio Dulce</div><div class="island-card-desc">Where Maya civilization meets the Caribbean — Garifuna culture, dramatic river gorges and extraordinary nature.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-nature">Nature</span></div></a>
      </div>
    </div>
  </div>
</section>
