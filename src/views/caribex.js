...
<link rel="manifest" href="/manifest-caribex.json">
<link rel="apple-touch-icon" href="/icons/caribex/apple-touch-icon.png">
<meta name="theme-color" content="#050c28">
<meta name="apple-mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
<meta name="apple-mobile-web-app-title" content="Caribex">
...
.island-card-img .flag{font-size:3.5rem;}
  ...
  <div class="dest-inner">
    ...
    <div class="region-section">
      ...
      <div class="islands-grid">
        ...
        <a href="/caribex/haiti" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#00209F,#D21034);">🇭🇹</div><div class="island-card-body"><div class="island-card-region">Greater Antilles</div><div class="island-card-name">Haiti</div><div class="island-card-desc">The first free Black republic — Citadelle Laferrière, extraordinary art and a history unlike any other.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-nature">Nature</span></div></a>
        <a href="/caribex/vieques-culebra" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#006994,#52B788);">🇵🇷</div><div class="island-card-body"><div class="island-card-region">Puerto Rico Offshore</div><div class="island-card-name">Vieques & Culebra</div><div class="island-card-desc">The world's brightest bioluminescent bay and Flamenco Beach — Puerto Rico's hidden island treasures.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-nature">Nature</span></div></a>
      </div>
    </div>
    ...
    <div class="region-section">
      ...
      <div class="islands-grid">
        ...
        <a href="/caribex/martinique" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#002395,#ED2939);">🇲🇶</div><div class="island-card-body"><div class="island-card-region">Lesser Antilles · France</div><div class="island-card-name">Martinique</div><div class="island-card-desc">French Caribbean — rhum agricole, volcanic Mount Pelée and the finest beaches in the French Antilles.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/guadeloupe" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#009A44,#002395);">🇬🇵</div><div class="island-card-body"><div class="island-card-region">Lesser Antilles · France</div><div class="island-card-name">Guadeloupe</div><div class="island-card-desc">The butterfly island — volcanic Basse-Terre, beautiful beaches and the finest French Caribbean rum.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-culture">Culture</span></div></a>
        <a href="/caribex/st-barths" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#002395,#F4A261);">🇧🇱</div><div class="island-card-body"><div class="island-card-region">Lesser Antilles · France</div><div class="island-card-name">St. Barths</div><div class="island-card-desc">The Caribbean's most exclusive island — superyacht harbor, world-class restaurants and perfect beaches.</div><span class="island-tag tag-luxury">Luxury</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/grenada" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#CE1126,#009E60);">🇬🇩</div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Grenada</div><div class="island-card-desc">The Spice Island — nutmeg plantations, the Bianca C wreck and St. George's most beautiful harbor town.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-culture">Culture</span></div></a>
        <a href="/caribex/antigua" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#CE1126,#0072C6);">🇦🇬</div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Antigua & Barbuda</div><div class="island-card-desc">365 beaches, Nelson's Dockyard UNESCO and the Caribbean's most prestigious sailing regatta.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-luxury">Luxury</span></div></a>
        <a href="/caribex/dominica" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#006B3F,#141414);">🇩🇲</div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Dominica</div><div class="island-card-desc">The Nature Island — boiling lakes, sperm whales, Champagne Reef and the most pristine rainforest in the Eastern Caribbean.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/st-kitts-nevis" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#009E49,#CE1126);">🇰🇳</div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">St. Kitts & Nevis</div><div class="island-card-desc">Britain's first Caribbean colony — Brimstone Hill UNESCO fortress, plantation hotels and birthplace of Alexander Hamilton.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-nature">Nature</span></div></a>
        <a href="/caribex/anguilla" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#00B4D8,#0077B6);">🇦🇮</div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Anguilla</div><div class="island-card-desc">Pristine white sand beaches, crystal waters and world-class cuisine in a quiet British territory.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-luxury">Luxury</span></div></a>
      </div>
    </div>
    ...
    <div class="region-section">
      ...
      <div class="islands-grid">
        ...
        <a href="/caribex/bonaire" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#003087,#FF6B35);">🇧🇶</div><div class="island-card-body"><div class="island-card-region">Dutch Caribbean</div><div class="island-card-name">Bonaire</div><div class="island-card-desc">The diver's paradise — 60+ shore dive sites, flamingos in the salt pans and the Caribbean's most protected reef.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-beach">Beach</span></div></a>
      </div>
    </div>
    ...
    <div class="region-section">
      ...
      <div class="islands-grid">
        ...
        <a href="/caribex/corn-islands" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#003F7F,#D21034);">🇳🇮</div><div class="island-card-body"><div class="island-card-region">Nicaragua</div><div class="island-card-name">Corn Islands</div><div class="island-card-desc">Nicaragua's undiscovered Caribbean paradise — world-class diving and fresh lobster at unbeatable prices.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/guatemala-caribbean" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#4997D0,#009A44);">🇬🇹</div><div class="island-card-body"><div class="island-card-region">Guatemala</div><div class="island-card-name">Livingston · Rio Dulce</div><div class="island-card-desc">Where Maya civilization meets the Caribbean — Garifuna culture, dramatic river gorges and extraordinary nature.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-nature">Nature</span></div></a>
      </div>
    </div>
  </div>
</section>
