  ...
  <div class="dest-inner">
    ...
    <div class="region-section">
      ...
      <div class="islands-grid">
        ...
        <a href="/caribex/cuba" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#003049,#C1121F);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇨🇺</span></div><div class="island-card-body"><div class="island-card-region">Greater Antilles</div><div class="island-card-name">Cuba</div><div class="island-card-desc">Havana's vintage cars, Viñales tobacco fields and salsa rhythms.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-nature">Nature</span></div></a>
        <a href="/caribex/jamaica" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#5C4033,#8D6E63);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇯🇲</span></div><div class="island-card-body"><div class="island-card-region">Greater Antilles</div><div class="island-card-name">Jamaica</div><div class="island-card-desc">Reggae birthplace, Blue Mountains coffee and Dunn's River Falls.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/grand-cayman" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#012169,#00B4D8);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇰🇾</span></div><div class="island-card-body"><div class="island-card-region">Greater Antilles</div><div class="island-card-name">Grand Cayman</div><div class="island-card-desc">Seven Mile Beach, Stingray City and world-class wall diving.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-luxury">Luxury</span></div></a>
        <a href="/caribex/haiti" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#00209F,#D21034);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇭🇹</span></div><div class="island-card-body"><div class="island-card-region">Greater Antilles</div><div class="island-card-name">Haiti</div><div class="island-card-desc">The first free Black republic — Citadelle Laferrière, extraordinary art and a history unlike any other.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-nature">Nature</span></div></a>
        <a href="/caribex/vieques-culebra" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#006994,#52B788);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇵🇷</span></div><div class="island-card-body"><div class="island-card-region">Puerto Rico Offshore</div><div class="island-card-name">Vieques & Culebra</div><div class="island-card-desc">The world's brightest bioluminescent bay and Flamenco Beach — Puerto Rico's hidden island treasures.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-nature">Nature</span></div></a>
      </div>
    </div>
    ...
    <div class="region-section">
      ...
      <div class="islands-grid">
        <a href="/caribex/barbados" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#F4A261,#E76F51);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇧🇧</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Barbados</div><div class="island-card-desc">Rum distilleries, coral reefs and the sophisticated side of the Caribbean.</div><span class="island-tag tag-luxury">Luxury</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/santa-lucia" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#65B741,#1A5276);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇱🇨</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Saint Lucia</div><div class="island-card-desc">Twin Piton peaks, volcanic springs and the most dramatic scenery in the Eastern Caribbean.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-luxury">Luxury</span></div></a>
        <a href="/caribex/trinidad-tobago" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#C8102E,#000000);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇹🇹</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Trinidad & Tobago</div><div class="island-card-desc">Carnival capital, steelpan birthplace and two completely different island personalities.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-nature">Nature</span></div></a>
        <a href="/caribex/sint-maarten" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#003087,#EF4135);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇸🇽</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Sint Maarten / Saint Martin</div><div class="island-card-desc">Two nations, one island — plane spotting at Maho Beach and French cuisine.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-culture">Culture</span></div></a>
        <a href="/caribex/martinique" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#002395,#ED2939);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇲🇶</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles · France</div><div class="island-card-name">Martinique</div><div class="island-card-desc">French Caribbean — rhum agricole, volcanic Mount Pelée and the finest beaches in the French Antilles.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/guadeloupe" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#009A44,#002395);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇬🇵</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles · France</div><div class="island-card-name">Guadeloupe</div><div class="island-card-desc">The butterfly island — volcanic Basse-Terre, beautiful beaches and the finest French Caribbean rum.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-culture">Culture</span></div></a>
        ...
        <a href="/caribex/grenada" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#CE1126,#009E60);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇬🇩</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Grenada</div><div class="island-card-desc">The Spice Island — nutmeg plantations, the Bianca C wreck and St. George's most beautiful harbor town.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-culture">Culture</span></div></a>
        <a href="/caribex/antigua" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#CE1126,#0072C6);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇦🇬</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Antigua & Barbuda</div><div class="island-card-desc">365 beaches, Nelson's Dockyard UNESCO and the Caribbean's most prestigious sailing regatta.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-luxury">Luxury</span></div></a>
        <a href="/caribex/dominica" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#006B3F,#141414);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇩🇲</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">Dominica</div><div class="island-card-desc">The Nature Island — boiling lakes, sperm whales, Champagne Reef and the most pristine rainforest in the Eastern Caribbean.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/st-kitts-nevis" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#009E49,#CE1126);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇰🇳</span></div><div class="island-card-body"><div class="island-card-region">Lesser Antilles</div><div class="island-card-name">St. Kitts & Nevis</div><div class="island-card-desc">Britain's first Caribbean colony — Brimstone Hill UNESCO fortress, plantation hotels and birthplace of Alexander Hamilton.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-nature">Nature</span></div></a>
      </div>
    </div>
    ...
    <div class="region-section">
      ...
      <div class="islands-grid">
        <a href="/caribex/aruba" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#0096C7,#48CAE4);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇦🇼</span></div><div class="island-card-body"><div class="island-card-region">Dutch Caribbean</div><div class="island-card-name">Aruba</div><div class="island-card-desc">360 days of sunshine, Eagle Beach and the most consistent weather in the Caribbean.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-luxury">Luxury</span></div></a>
        <a href="/caribex/curacao" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#003087,#FF6B35);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇨🇼</span></div><div class="island-card-body"><div class="island-card-region">Dutch Caribbean</div><div class="island-card-name">Curaçao</div><div class="island-card-desc">UNESCO colonial Willemstad, world-class wall diving and the most colorful island in the Caribbean.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-beach">Beach</span></div></a>
        <a href="/caribex/bonaire" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#003087,#FF6B35);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇧🇶</span></div><div class="island-card-body"><div class="island-card-region">Dutch Caribbean</div><div class="island-card-name">Bonaire</div><div class="island-card-desc">The diver's paradise — 60+ shore dive sites, flamingos in the salt pans and the Caribbean's most protected reef.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-beach">Beach</span></div></a>
      </div>
    </div>
    ...
    <div class="region-section">
      ...
      <div class="islands-grid">
        <a href="/caribex/usvi" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#002868,#BF0A30);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇻🇮</span></div><div class="island-card-body"><div class="island-card-region">US Territory</div><div class="island-card-name">US Virgin Islands</div><div class="island-card-desc">No passport needed — Magens Bay and Virgin Islands National Park.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-nature">Nature</span></div></a>
        <a href="/caribex/bvi" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#012169,#00B4D8);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇻🇬</span></div><div class="island-card-body"><div class="island-card-region">UK Territory</div><div class="island-card-name">British Virgin Islands</div><div class="island-card-desc">Sailing capital of the Caribbean — The Baths and the legendary Soggy Dollar Bar.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-luxury">Luxury</span></div></a>
        <a href="/caribex/turks-caicos" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#00B4D8,#0077B6);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇹🇨</span></div><div class="island-card-body"><div class="island-card-region">UK Territory</div><div class="island-card-name">Turks & Caicos</div><div class="island-card-desc">Grace Bay — the world's best beach — and the clearest water in the Caribbean.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-luxury">Luxury</span></div></a>
        <a href="/caribex/bahamas" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#023E8A,#0096C7);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇧🇸</span></div><div class="island-card-body"><div class="island-card-region">Commonwealth</div><div class="island-card-name">The Bahamas</div><div class="island-card-desc">700 islands, swimming pigs in the Exumas and the clearest water on earth.</div><span class="island-tag tag-beach">Beach</span><span class="island-tag tag-luxury">Luxury</span></div></a>
      </div>
    </div>
    ...
    <div class="region-section">
      ...
      <div class="islands-grid">
        <a href="/caribex/tulum" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#2D6A4F,#52B788);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇲🇽</span></div><div class="island-card-body"><div class="island-card-region">Mexico</div><div class="island-card-name">Tulum · Cancún · Holbox</div><div class="island-card-desc">Mayan ruins above Caribbean water, cenotes and bohemian beach culture.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-nature">Nature</span></div></a>
        <a href="/caribex/cartagena" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#FFD700,#C8102E);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇨🇴</span></div><div class="island-card-body"><div class="island-card-region">Colombia</div><div class="island-card-name">Cartagena · Santa Marta</div><div class="island-card-desc">Colombia's walled colonial city — one of the most beautiful in the Americas.</div><span class="island-tag tag-culture">Culture</span><span class="island-tag tag-beach">Beach</span></div></a>
        ...
        <a href="/caribex/costa-rica" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#1B4332,#52B788);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇨🇷</span></div><div class="island-card-body"><div class="island-card-region">Costa Rica</div><div class="island-card-name">Puerto Viejo · Tortuguero</div><div class="island-card-desc">Where the jungle meets the sea — sea turtles and Afro-Caribbean culture.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-culture">Culture</span></div></a>
        <a href="/caribex/belize" class="island-card"><div class="island-card-img" style="background:linear-gradient(135deg,#003F5C,#00B4D8);"><img style="display:none" alt="" loading="lazy" onerror="this.style.display='none'"><span class="flag">🇧🇿</span></div><div class="island-card-body"><div class="island-card-region">Belize</div><div class="island-card-name">Ambergris Caye · Blue Hole</div><div class="island-card-desc">The Great Blue Hole and the second largest barrier reef on earth.</div><span class="island-tag tag-nature">Nature</span><span class="island-tag tag-beach">Beach</span></div></a>
