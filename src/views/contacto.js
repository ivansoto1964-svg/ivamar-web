...
.contact-page{font-family:'Plus Jakarta Sans',sans-serif;background:#ffffff;color:#1a1a2e;margin:-20px;overflow-x:hidden;}
...
.contact-back:hover{color:#1a1a2e;border-color:rgba(255,255,255,0.25);}
...
.contact-tag{display:inline-block;font-family:'JetBrains Mono',monospace;font-size:0.68rem;color:#00C896;letter-spacing:0.15em;text-transform:uppercase;margin-bottom:1rem;padding:0.3rem 0.8rem;border:1px solid rgba(0,229,200,0.2);border-radius:4px;}
...
.contact-hero h1 em{font-family:'Instrument Serif',serif;font-style:italic;font-weight:400;color:#00C896;}
...
.contact-option{background:#f8f9fa;border:1px solid rgba(255,255,255,0.06);border-radius:16px;padding:1.8rem;transition:all 0.3s;position:relative;overflow:hidden;}
.contact-option::before{content:'';position:absolute;top:0;left:0;right:0;height:2px;background:linear-gradient(90deg,transparent,#00C896,transparent);opacity:0;transition:opacity 0.3s;}
...
.contact-option-btn.primary{background:#00C896;color:#ffffff;}
.contact-option-btn.primary:hover{box-shadow:0 6px 20px rgba(0,229,200,0.25);transform:translateY(-1px);}
.contact-option-btn.ghost{background:transparent;color:#00C896;border:1px solid rgba(0,229,200,0.3);}
...
.contact-info{background:#ffffff;border:1px solid rgba(0,0,0,.03);border-radius:16px;padding:2rem;margin-bottom:2rem;}
.contact-info-title{font-family:'JetBrains Mono',monospace;font-size:0.7rem;color:#00C896;letter-spacing:0.15em;text-transform:uppercase;margin-bottom:1.5rem;display:flex;align-items:center;gap:0.5rem;}
.contact-info-title::before{content:'';width:16px;height:1px;background:#00C896;}
...
.contact-info-value{font-size:0.88rem;color:#1a1a2e;font-weight:500;}

.contact-footer{background:#ffffff;padding:2rem 2.5rem;border-top:1px solid rgba(0,0,0,.02);display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:1rem;font-size:0.8rem;color:#4A5568;}
...
.contact-footer-links a:hover{color:#00C896;}
...
<div class="contact-page">
  ...
  <div class="contact-hero">
    ...
    <h1>Hablemos de<br><em>tu negocio</em></h1>
  ...
  <div class="contact-content">
    ...
    <div class="contact-options">
      ...
      <div class="contact-option">
        ...
        <div class="contact-option-title">WhatsApp (más rápido)</div>
        <div class="contact-option-desc">La forma más rápida de hablar con nosotros. Respondemos en minutos durante horas de negocio.</div>
        <a href="https://wa.me/18635216708" target="_blank" class="contact-option-btn wa">Abrir WhatsApp →</a>
      </div>

      <div class="contact-option">
        <div class="contact-option-icon">📋</div>
        <div class="contact-option-title">Solicitar tu página</div>
        <div class="contact-option-desc">¿Listo para empezar? Llena el formulario, elige tu plan y paga de forma segura con Stripe.</div>
        <a href="/cotizar" class="contact-option-btn primary">Empezar ahora →</a>
      </div>

      <div class="contact-option">
        <div class="contact-option-icon">🌐</div>
        <div class="contact-option-title">Ver Demos en Vivo</div>
        <div class="contact-option-desc">Mira ejemplos reales de cómo funciona una página de Ivamar AI para distintos tipos de negocios.</div>
        <a href="/demos" class="contact-option-btn ghost">Ver Demos →</a>
      </div>

      <div class="contact-option">
        <div class="contact-option-icon">💼</div>
        <div class="contact-option-title">Alianzas y Revendedores</div>
        <div class="contact-option-desc">¿Quieres ofrecer Ivamar AI a tus clientes? Pregúntanos sobre nuestro programa de partners.</div>
        <a href="https://wa.me/18635216708?text=Hola%2C%20me%20interesa%20el%20programa%20de%20partners%20de%20Ivamar%20AI" target="_blank" class="contact-option-btn ghost">Ser Partner →</a>
      </div>

    </div>

    <div class="contact-info">
      <div class="contact-info-title">Información de la empresa</div>
      <div class="contact-info-grid">
        ...
        <div class="contact-info-item">
          <div class="contact-info-label">Estado</div>
          <div class="contact-info-value">Delaware, USA</div>
        </div>
        <div class="contact-info-item">
          <div class="contact-info-label">Alcance</div>
          <div class="contact-info-value">Desde USA para el mundo 🌎</div>
        </div>
        <div class="contact-info-item">
          <div class="contact-info-label">Idiomas</div>
          <div class="contact-info-value">Español · English</div>
        </div>
        <div class="contact-info-item">
          <div class="contact-info-label">Horario</div>
          <div class="contact-info-value">Lun–Vie 9am–6pm · IvA 24/7</div>
        </div>
        <div class="contact-info-item">
