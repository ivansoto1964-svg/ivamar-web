...
async function callDealerAssistant(message) {
  try {
    ...
    const reply = data.reply || "I'm having a quick issue. Please email us at connect@ivamarai.com";
    ...
    return "I'm having a quick issue. Please email us at connect@ivamarai.com";
  }
}
...
function showTyping() {
  ...
  div.id = 'acTyping';
  div.innerHTML = '<span style="opacity:0.5">Assistant is typing...</span>';
